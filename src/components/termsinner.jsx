...
export const TermsInner = () => {
  return (
    <article className='c-entry'>
      ...
      <dl>
        <dt className='c-term__title'>第1条（適用）</dt>
        <dd className='c-term__content'>
          <ol className='c-section'>
            <li className='c-section__item'>
              本規約は、本サービスの提供条件及び本サービスの利用に関する当社と登録ユーザーとの間の権利義務関係を定めることを目的とし、登録ユーザーと当社との間の本サービスの利用に関わる一切の関係に適用されます。
            </li>
            <li className='c-section__item'>
              当社が当社ウェブサイト上で掲載する本サービス利用に関するルール(
              <a href='/privacy-policy/' className='c-link c-link:inline'>
                https://kamenwriter.com/privacy-policy/
              </a>
              )は、本規約の一部を構成するものとします。
            </li>
            <li className='c-section__item'>
        ...
        <dt className='c-term__title'>第2条（定義）</dt>
        <dd className='c-term__content'>
          本規約において使用する以下の用語は、各々以下に定める意味を有するものとします。
          <ol className='c-sub-section'>
            <li className='c-sub-section__item'>
            ...
            <li className='c-sub-section__item'>「当社」とは、仮面ライターを意味します。</li>
            <li className='c-sub-section__item'>
              「当社ウェブサイト」とは、そのドメインが「kamenwriter.com」である、当社が運営するウェブサイト（理由の如何を問わず、当社のウェブサイトのドメインまたは内容が変更された場合は、当該変更後のウェブサイトを含みます。）を意味します。
            </li>
            <li className='c-sub-section__item'>
              「登録ユーザー」とは、第3条（登録）に基づいて本サービスの利用者としての登録がなされた個人または法人を意味します。
            </li>
            <li className='c-sub-section__item'>
              「本サービス」とは、当社が提供する仮面ライターという名称のサービス（理由の如何を問わずサービスの名称または内容が変更された場合は、当該変更後のサービスを含みます。）を意味します。
            </li>
          </ol>
        </dd>
        <dt className='c-term__title'>第3条（登録）</dt>
        <dd className='c-term__content'>
          <ol className='c-section'>
            <li className='c-section__item'>
            ...
            <li className='c-section__item'>
              ...
              <ol className='c-sub-section'>
                ...
                <li className='c-sub-section__item'>第10条に定める措置を受けたことがある場合</li>
                <li className='c-sub-section__item'>その他、登録を適当でないと当社が判断した場合</li>
              </ol>
            </li>
          </ol>
        </dd>
        <dt className='c-term__title'>第4条（登録事項の変更）</dt>
        <dd className='c-term__content'>
          登録ユーザーは、登録事項に変更があった場合、当社の定める方法により当該変更事項を遅滞なく当社に通知するものとします。
        </dd>
        <dt className='c-term__title'>第5条（パスワード及びユーザーIDの管理）</dt>
        <dd className='c-term__content'>
          <ol className='c-section'>
            <li className='c-section__item'>
        ...
        <dt className='c-term__title'>第6条（料金及び支払方法）</dt>
        <dd className='c-term__content'>
          <ol className='c-section'>
            <li className='c-section__item'>
        ...
        <dt className='c-term__title'>第7条（禁止事項）</dt>
        <dd className='c-term__content'>
          登録ユーザーは、本サービスの利用にあたり、以下の各号のいずれかに該当する行為または該当すると当社が判断する行為をしてはなりません。
          <ol className='c-sub-section'>
            <li className='c-sub-section__item'>法令に違反する行為または犯罪行為に関連する行為</li>
            <li className='c-sub-section__item'>
              当社、本サービスの他の利用者またはその他の第三者に対する詐欺または脅迫行為
            </li>
            <li className='c-sub-section__item'>公序良俗に反する行為</li>
            <li className='c-sub-section__item'>
            ...
            <li className='c-sub-section__item'>本サービスのネットワークまたはシステム等に過度な負荷をかける行為</li>
            <li className='c-sub-section__item'>
              当社が提供するソフトウェアその他のシステムに対するリバースエンジニアリングその他の解析行為
            </li>
            <li className='c-sub-section__item'>本サービスの運営を妨害するおそれのある行為</li>
            <li className='c-sub-section__item'>当社のネットワークまたはシステム等への不正アクセス</li>
            <li className='c-sub-section__item'>第三者に成りすます行為</li>
            <li className='c-sub-section__item'>本サービスの他の利用者のIDまたはパスワードを利用する行為</li>
            <li className='c-sub-section__item'>
              当社が事前に許諾しない本サービス上での宣伝、広告、勧誘、または営業行為
            </li>
            <li className='c-sub-section__item'>本サービスの他の利用者の情報の収集</li>
            <li className='c-sub-section__item'>
              当社、本サービスの他の利用者またはその他の第三者に不利益、損害、不快感を与える行為
            </li>
            <li className='c-sub-section__item'>
              当社ウェブサイト上で掲載する本サービス利用に関するルール(
              <a href='/terms/' className='c-link c-link:inline'>
                https://kamenwriter.com/terms/
              </a>
              )に抵触する行為
            </li>
            <li className='c-sub-section__item'>反社会的勢力等への利益供与</li>
            <li className='c-sub-section__item'>面識のない異性との出会いを目的とした行為</li>
            <li className='c-sub-section__item'>前各号の行為を直接または間接に惹起し、または容易にする行為</li>
            <li className='c-sub-section__item'>前各号の行為を試みること</li>
            <li className='c-sub-section__item'>その他、当社が不適切と判断する行為</li>
          </ol>
        </dd>
        <dt className='c-term__title'>第8条（本サービスの停止等）</dt>
        <dd className='c-term__content'>
          ...
          <ol className='c-sub-section'>
            ...
            <li className='c-sub-section__item'>その他、当社が停止または中断を必要と判断した場合</li>
          </ol>
        </dd>
        <dt className='c-term__title'>第9条（権利帰属）</dt>
        <dd className='c-term__content'>
          <ol className='c-section'>
            <li className='c-section__item'>
        ...
        <dt className='c-term__title'>第10条（登録抹消等）</dt>
        <dd className='c-term__content'>
          <ol className='c-section'>
            <li className='c-section__item'>
              ...
              <ol className='c-sub-section'>
                <li className='c-sub-section__item'>本規約のいずれかの条項に違反した場合</li>
                <li className='c-sub-section__item'>登録事項に虚偽の事実があることが判明した場合</li>
                <li className='c-sub-section__item'>
                  支払停止もしくは支払不能となり、または破産手続開始、民事再生手続開始、会社更生手続開始、特別清算開始若しくはこれらに類する手続の開始の申立てがあった場合
                </li>
                <li className='c-sub-section__item'>120日間本サービスの利用がない場合</li>
                <li className='c-sub-section__item'>
                  当社からの問い合わせその他の回答を求める連絡に対して60日間応答がない場合
                </li>
                <li className='c-sub-section__item'>第3条第4項各号に該当する場合</li>
                <li className='c-sub-section__item'>
        ...
        <dt className='c-term__title'>第11条（退会）</dt>
        <dd className='c-term__content'>
          <ol className='c-section'>
            <li className='c-section__item'>
            ...
            <li className='c-section__item'>退会後の利用者情報の取扱いについては、第15条の規定に従うものとします。</li>
          </ol>
        </dd>
        <dt className='c-term__title'>第12条（本サービスの内容の変更、終了）</dt>
        <dd className='c-term__content'>
          <ol className='c-section'>
            <li className='c-section__item'>
        ...
        <dt className='c-term__title'>第13条（保証の否認及び免責）</dt>
        <dd className='c-term__content'>
          <ol className='c-section'>
            <li className='c-section__item'>
            ...
            <li className='c-section__item'>
              当社は、本サービスに関して登録ユーザーが被った損害につき、過去6ヶ月間に登録ユーザーが当社に支払った対価の金額を超えて賠償する責任を負わないものとし、また、付随的損害、間接損害、特別損害、将来の損害及び逸失利益にかかる損害については、賠償する責任を負わないものとします。
            </li>
            <li className='c-section__item'>
        ...
        <dt className='c-term__title'>第14条（秘密保持）</dt>
        <dd className='c-term__content'>
          登録ユーザーは、本サービスに関連して当社が登録ユーザーに対して秘密に取扱うことを求めて開示した非公知の情報について、当社の事前の書面による承諾がある場合を除き、秘密に取扱うものとします。
        </dd>
        <dt className='c-term__title'>第15条（利用者情報の取扱い）</dt>
        <dd className='c-term__content'>
          <ol className='c-section'>
            <li className='c-section__item'>
              当社による登録ユーザーの利用者情報の取扱いについては、別途当社プライバシーポリシー(
              <a className='c-link c-link:inline' href='/privacy/' target='_blank' rel='noopener'>
                https://kamenwriter.com/privacy-policy
              </a>
        ...
        <dt className='c-term__title'>第16条（本規約等の変更）</dt>
        <dd className='c-term__content'>
        ...
        <dt className='c-term__title'>第17条（連絡／通知）</dt>
        <dd className='c-term__content'>
          <ol className='c-section'>
            <li className='c-section__item'>
        ...
        <dt className='c-term__title'>第18条（サービス利用契約上の地位の譲渡等）</dt>
        <dd className='c-term__content'>
          <ol className='c-section'>
            <li className='c-section__item'>
        ...
        <dt className='c-term__title'>第19条（分離可能性）</dt>
        <dd className='c-term__content'>
          本規約のいずれかの条項またはその一部が、消費者契約法その他の法令等により無効または執行不能と判断された場合であっても、本規約の残りの規定及び一部が無効または執行不能と判断された規定の残りの部分は、継続して完全に効力を有するものとします。
        </dd>
        <dt className='c-term__title'>第20条（準拠法及び管轄裁判所）</dt>
        <dd className='c-term__content'>
          <ol className='c-section'>
            <li className='c-section__item'>本規約及びサービス利用契約の準拠法は日本法とします。</li>
            <li className='c-section__item'>
      ...
      <p className='c-term__memo'>【2022年00月00日 制定】</p>
    </article>
  );
};
