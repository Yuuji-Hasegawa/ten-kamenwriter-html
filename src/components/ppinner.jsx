...
export const PpInner = () => {
  return (
    <article className='c-entry'>
      <p>
        仮面ライター（以下「当社」といいます。）は、当社の提供するサービス（以下「本サービス」といいます。）における、ユーザーについての個人情報を含む利用者情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」といいます。）を定めます。
      </p>
      <dl>
        <dt className='c-term__title'>第1条（収集する利用者情報及び収集方法）</dt>
        <dd className='c-term__content'>
          ...
          <ol className='c-sub-section'>
            <li className='c-sub-section__item'>
              <span className='c-term-strong'>ユーザーからご提供いただく情報</span>
            ...
            <li className='c-sub-section__item'>
              <span className='c-term-strong'>ユーザーが本サービスを利用するにあたって、当社が収集する情報</span>
        ...
        <dt className='c-term__title'>第2条（利用目的）</dt>
        <dd className='c-term__content'>
          ...
          <ol className='c-sub-section'>
            ...
            <li className='c-sub-section__item'>ユーザーのトラフィック測定及び行動測定のため</li>
            <li className='c-sub-section__item'>広告の配信、表示及び効果測定のため</li>
            <li className='c-sub-section__item'>本サービスに関するご案内、お問い合わせ等への対応のため</li>
            <li className='c-sub-section__item'>
              本サービスに関する当社の規約、ポリシー等（以下「規約等」といいます。）に違反する行為に対する対応のため
            </li>
            <li className='c-sub-section__item'>本サービスに関する規約等の変更などを通知するため</li>
          </ol>
        </dd>
        <dt className='c-term__title'>第3条（通知・公表または同意取得の方法、利用中止要請の方法）</dt>
        <dd className='c-term__content'>
        ...
        <dt className='c-term__title'>第4条（外部送信、第三者提供、情報収集モジュールの有無）</dt>
        <dd className='c-term__content'>
          ...
          <ol className='c-section'>
            <li className='c-section__item'>
              Google Analytics
              <dl className='c-table c-table:term-inner'>
                <dt className='c-table__title'>提携先</dt>
                <dd className='c-table__content'>グーグル合同会社</dd>
                <dt className='c-table__title'>利用目的</dt>
                <dd className='c-table__content'>アクセス情報の解析、サービス、サイトの改善</dd>
                <dt className='c-table__title'>プライバシーポリシーのURL</dt>
                ...
                <dt className='c-table__title'>オプトアウト（無効化）URL</dt>
                <dd className='c-table__content'>
                  <a
        ...
        <dt className='c-term__title'>第5条（第三者提供）</dt>
        <dd className='c-term__content'>
          ...
          <ol className='c-sub-section'>
            ...
            <li className='c-sub-section__item'>合併その他の事由による事業の承継に伴って個人情報が提供される場合</li>
            <li className='c-sub-section__item'>
        ...
        <dt className='c-term__title'>第6条（共同利用）</dt>
        <dd className='c-term__content'>
          当社は、以下のとおりユーザーの個人情報を共同利用します。
          <dl className='c-table c-table:term'>
            <dt className='c-table__title c-table__title:count'>(1) 共同して利用される個人情報の項目</dt>
            <dd className='c-table__content'>
              <ul className='c-list'>
                <li>氏名</li>
                <li>メールアドレス</li>
            ...
            <dt className='c-table__title c-table__title:count'>(2) 共同して利用する者の範囲</dt>
            <dd className='c-table__content'>当社と機密保持契約を結んだ個人または法人</dd>
            <dt className='c-table__title c-table__title:count'>(3) 共同して利用する者の利用目的</dt>
            <dd className='c-table__content'>当該サービスにおける利用目的と同じ</dd>
            <dt className='c-table__title c-table__title:count'>
              (4) 個人情報の管理について責任を有する者の氏名または名称
            </dt>
            <dd className='c-table__content'>長谷川　雄治</dd>
          </dl>
        </dd>
        <dt className='c-term__title'>第7条（個人情報の開示）</dt>
        <dd className='c-term__content'>
        ...
        <dt className='c-term__title'>第8条（個人情報の訂正及び利用停止等）</dt>
        <dd className='c-term__content'>
          <ol className='c-section'>
            <li className='c-section__item'>
        ...
        <dt className='c-term__title'>第9条（お問い合わせ窓口）</dt>
        <dd className='c-term__content'>
          ご意見、ご質問、苦情のお申出その他利用者情報の取扱いに関するお問い合わせは、下記の窓口までお願いいたします。
          <dl className='c-table c-table:term'>
            <dt className='c-table__title'>名称</dt>
            <dd className='c-table__content'>仮面ライター</dd>
            <dt className='c-table__title'>個人情報取扱責任者</dt>
            <dd className='c-table__content'>長谷川　雄治</dd>
            <dt className='c-table__title'>連絡先</dt>
            <dd className='c-table__content'>
              <a
                className='c-link c-link:inline'
        ...
        <dt className='c-term__title'>第10条（プライバシーポリシーの変更手続）</dt>
        <dd className='c-term__content'>
